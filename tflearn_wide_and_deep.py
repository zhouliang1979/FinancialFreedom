...
CATEGORICAL_COLUMNS = ["cate_level1_id" : 44, "cate_level2_id" : 782, "leaf_cate_id" : 5207, "price_range" : 4221, "user_group_id" : 25, "channel" : 3]

CONTINUOUS_COLUMNS = ["f0","f1","f2","f3","f4","f5","f6","f7","f8","f9","f10","f11","f12","f13","f14","f15","f16","f17","f18","f19","f20","f21","f22","f23","f24","f25","f26","f27","f28","f29","f30","f31","f32","f33","f34","f35"]
...
class TFLearnWideAndDeep(object):
    ...
    def load_data(self, train_dfn="dm_c2b_v3_cate_deal_train_set_02", test_dfn="dm_c2b_v3_cate_deal_test_set_02"):
        '''
        ...
        self.train_data[self.label_column] = self.train_data["target"]
        self.test_data[self.label_column] = self.test_data["target"]
