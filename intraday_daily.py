...
"""
  一个日内交易策略
  1. 每天做多交易两次
  2. 开盘立刻入场， 昨天收>开，则开多；昨天收<开，则开空
  3. 入场后如果浮盈超过10个跳价， 当浮盈回撤5个跳价时离场
     或者浮盈一直不超过10个跳价，且价格反方向运动穿越开盘价1小时
     后平仓。（比如，开盘开了多仓， 但是价格开始下跌，并且跌破开盘价
     持续一小时， 此时平仓）
  4. 如步骤3所述穿越开盘价1小时后， 反向开仓， 本次开仓无论如何， 一直
     到收盘才平仓
"""
